        ...
        <div class="breadCrumbHolder module">
            <div class="breadCrumb module">
                <ul>
                    ...
                    <li><g:link action="showEntradas" id="${mensagemInstance.id}"> <g:message code="default.show.label" args="[entityName]" /></g:link></li>
                </ul>
            </div>
        </div>
            ...
            <fieldset>
                <div class="widget first">
                    ...
                    <g:if test="${mensagemInstance?.emailDestinatario}">
                        <div class="rowElem"><label><span id="destinatarios-label" class="property-label"><g:message code="mensagem.destinatarios.label" default="Destinatarios" /></span>:</label>
                            <div class="formRight">
                                    ...
                                    <span class="property-value" aria-labelledby="destinatarios-label"><h4> ${mensagemInstance.grupos.nome.toString().replaceAll("\\[|\\]","")}</h4></span>
                    ...
                    <g:if test="${mensagemInstance?.mensagem}">
                        ...
                        <div class="rowElem" style="background-color: #99ccff"><label><span id="mensagem-label" class="property-label"><g:message code="mensagem.mensagem.label" default="Mensagem" /></span>:</label>
                    ...
                    <div id="listaResposta">
                       ...
                       <div class="rowElem"><label><span id="resposta-label" class="property-label"><g:message code="mensagem.destinatarios.label" default="Resposta" /></span>:</label>
                              <div class="formRight">
                                 <g:formRemote name="formRespsota" url="[action: 'ajaxResposta']" update="listaResposta" onLoading="\$('#loaderResposta').show();\$('#btnCreateResposta').hide();" onComplete="\$('#btnCreateResposta').show();\$('#loaderResposta').hide();\$('#resposta').val('');">
                                     <g:hiddenField name="mensagemOrginal" value="${mensagemInstance?.id}" />
                                     <g:textArea name="resposta" id="resposta" rows="5" />
